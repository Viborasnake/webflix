/* Notas del presentador · WebFlix Shark Tank v3 (~8 min)
 * Guion v3 en punteo + hints alineados a la slide
...
window.WEBFLIX_NOTES = [
  {
    ...
    role: "Apertura",
    window: "Setup · saludo",
    onScreen: "Hook “Perdemos 1 de cada 3…” · 310M · 42%→29% · ~8 min",
    say: [
      {
        text: "Hola a todos. Somos el equipo 5: Cris, Tami, Vale y yo.",
        hint: "Erick · Tami · Cris · Vale · Grupo 5 · ~8 min",
      },
      {
    ...
    highlight: [
      "Saludo corto + equipo en una frase",
    ...
    glossary: ["Day-7", "cold-start", "primer-momento-valor", "outcome", "activacion"],
  },
  {
    id: 1,
    n: "02",
    ...
    say: [
      {
        ...
        hint: "310 M · ~360 M MAU · usuarios nuevos · perfiles familiares",
      },
      {
      ...
      },
      {
        ...
        hint: "Honestidad del experimento · no mueve Day-7 directo · le apunta",
      },
    ],
    highlight: [
      "310 M = escala, no tamaño de muestra",
      "−13 pp · descubrimiento, no catálogo",
      "Frase ancla: “no lo mueve directamente, pero le apunta”",
    ],
    avoid: [
      "No decir “el algoritmo está roto”",
      "No vender Day-7 como resultado de este test",
    ],
    glossary: ["Day-7", "pp", "caida-relativa", "MAU", "activacion", "outcome", "supuesto"],
  },
  {
    id: 2,
    n: "03",
    title: "Entendimiento",
    speaker: "Erick",
    role: "Tres fricciones · 0:55→1:35",
    window: "0:55 → 1:35",
    onScreen: "3 fricciones · supuesto a validar · cadena no virtuosa",
    say: [
      {
        text: "Identificamos tres fricciones concretas. Primero, el usuario navega demasiado antes de encontrar algo que le llame la atención.",
      ...
      },
      {
        ...
        hint: "02 · Onboarding mal diseñado · el paso que existe está mal hecho",
      },
      {
        ...
        hint: "03 · Cold start · velocidad de personalización, no de oferta",
      },
      {
        ...
        hint: "Insight de equipo · supuesto a validar, no hecho",
      },
    ],
    highlight: [
      "Tres fricciones, una distinción: motor no roto",
      "Supuesto a validar cierra el arco de Erick",
    ],
    avoid: [
      "No culpar al catálogo como única causa",
      "No saltar a la solución sin fricciones",
    ],
    glossary: ["cold-start", "friccion", "onboarding", "supuesto", "sesion-cero"],
  },
  {
    id: 3,
    n: "04",
    ...
    highlight: [
      "“Rediseñar, no agregar”",
      "3 a 5 preferencias (no “solo tres”)",
      "Guardrail <30 s = muerte inmediata",
    ],
    avoid: [
      "No vender H·A / H·B como test de hoy",
      "No tocar motor ni catálogo en el alcance",
    ],
    glossary: ["H-A", "H-B", "H-C", "guardrail", "<30s", "redisenar-no-agregar", "falsable", "onboarding"],
  },
  {
    id: 4,
    n: "05",
    ...
    window: "2:20 → 3:25",
    onScreen: "Control = onboarding actual · Experimental = swipe · umbrales · 30–50",
    say: [
      {
        ...
        hint: "Probamos la idea antes de la ingeniería · WoZ longitudinal",
      },
      {
        ...
        hint: "Control = onboarding de hoy · Experimental = swipe 3–5 · no “sin preferencias”",
      },
      {
        ...
        hint: "Muestra 30–50 · Seguimiento 7 días · Ejecución 2 semanas",
      },
      {
    ...
    highlight: [
      "⭐ Énfasis Tami",
      "Control = onboarding actual (largo), no “sin selección”",
  ...
  },
  {
    ...
    title: "Herramientas",
    speaker: "Cristian",
    role: "IA copiloto · 3:25→3:50",
    window: "3:25 → 3:50",
    onScreen: "Figma AI · Claude + ChatGPT · señales tempranas",
    say: [
      {
    ...
    avoid: [
      "No vender la IA como validación de usuarios",
    ],
    glossary: ["copiloto", "supuesto", "cold-start", "falsable"],
  },
  {
    id: 6,
    n: "07",
    title: "Prototipo ⭐",
    speaker: "Cristian",
    role: "Demo · 3:50→5:55 · ÉNFASIS",
    window: "3:50 → 5:55",
    onScreen: "1 Swipe · 2 Resumen · 3 Catálogo WoZ · 4 Control actual",
    say: [
      {
      ...
      {
        text: "Recorramos el flujo paso a paso. Pantalla uno: justo después de suscribirse, aparece “Así Webflix se parece más a ti. Elige lo que te gusta ver, te tomará menos de 30 segundos.” Desliza a la derecha si te interesa, a la izquierda si prefieres pasar. Objetivo: entre 3 y 5 gustos.",
        hint: "1 · Swipe 3–5 · “Así Webflix se parece más a ti” · <30 s",
      },
      {
        text: "El usuario empieza a deslizar. Acepta lo que le interesa, descarta lo que no, hasta que la app indica “máximo alcanzado”: ya tiene sus preferencias.",
        hint: "Swipe en vivo · máximo alcanzado",
      },
      {
        text: "Pantalla dos: un resumen rápido — “Ya conocimos un poco más de ti” — con lo que detectó. Este paso importa: el usuario siente que fue escuchado antes de ver resultados.",
        hint: "2 · Resumen de preferencias · “Ya conocimos un poco más de ti”",
      },
      {
        text: "Pantalla tres: carga el catálogo personalizado. Acá está el truco del Wizard of Oz: no hay algoritmo procesando en tiempo real, es maqueta armada a mano, invisible para el usuario. Si reproduce, la app puede mostrar alta afinidad.",
        hint: "3 · Catálogo personalizado (WoZ) · afinidad ~95%",
      },
      {
        text: "Ese es el grupo experimental. El grupo control ve exactamente el onboarding de hoy: el mismo objetivo, capturar gustos, pero en su versión larga y menos amigable, validando en vivo la fricción del mapa de supuestos.",
        hint: "4 · Control = onboarding de hoy · valida la fricción",
      },
    ],
    highlight: [
      "⭐ Énfasis · recorrido en vivo",
      "3 pantallas exp + contraste control",
      "Plan B: 1 vivo · 2 video · 3 capturas",
    ],
    avoid: [
      "No decir que ya corre el motor real",
      "No improvisar fuera del tramo crítico",
    ],
    glossary: ["WoZ", "tramo-critico", "Ley-Jakob", "affordance", "guardrail", "<30s", "play-valido", "control"],
  },
  {
    id: 7,
    n: "08",
    title: "Resultados",
    speaker: "Valeria",
    role: "Simulación · 5:55→6:55",
    window: "5:55 → 6:55",
    onScreen: "84% · 69% · +12% · 78% · Day-7 exploratorio 29→33",
    say: [
      {
    ...
    highlight: [
      ...
      "Primaria vs cualitativa vs exploratoria",
    ],
    avoid: [
      "NUNCA presentar simulados como campo real",
      "No vender Day-7 29→33 como victoria",
    ],
    glossary: ["simulacion", "play-valido", "Watch-Time", "guardrail", "intencion-declarada", "exploratoria", "Day-7", "n-direccional"],
  },
  {
    id: 8,
    n: "09",
    title: "Aprendizajes ⭐",
    speaker: "Valeria",
    role: "Decisión · 6:55→8:00 · ÉNFASIS Y CIERRE",
    window: "6:55 → 8:00",
    onScreen: "Confirma · perseverar · telemetría motor · pedido piloto",
    say: [
      {
    ...
    highlight: [
      ...
      "Confirma + ajuste motor real",
      "Supuesto “motor lento” sigue abierto → telemetría primero",
    ],
    avoid: [
      "No pedir “arreglar el algoritmo” sin piloto",
      "No decir que ya probamos que el motor es lento",
    ],
    glossary: ["confirma", "perseverar", "piloto", "sesion-cero", "guardrail", "refutacion", "supuesto"],
  },
  {
    id: 9,
    n: "10",
    ...
    highlight: [
      "Equipo asiente",
      "Q&A: Erick cifras · Tami exp · Cris demo · Vale decisión",
    ],
    avoid: [
      "No recontar todo el caso en cada respuesta",
      "No inventar cifras fuera de pantalla",
    ],
    glossary: ["piloto", "Day-7", "confirma", "guardrail", "H-C"],
  },
];
